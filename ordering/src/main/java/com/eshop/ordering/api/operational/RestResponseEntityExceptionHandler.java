package com.eshop.ordering.api.operational;
...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(final MethodArgumentNotValidException ex,
        ...
        //     String errorMessage = "There was an error validating the arguments sent to the method.";
        //     Map<String, String> errors = validationErrors;
        // };

        return handleExceptionInternal(ex, validationErrors, headers, HttpStatus.BAD_REQUEST, request);
    }
